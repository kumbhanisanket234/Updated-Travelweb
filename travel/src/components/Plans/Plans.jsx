    ...
    <div className='Plans' id='plans'>
      <div className="Plans-content">
        ...
        <div className="prenext-btn justify-content-center d-flex">
          <button className="btn-previous btn btn-default" id='btn-previous' disabled={currentPage <= 1 ? true : false} onClick={handlePreviousBtn} style={active ? { backgroundColor: "#FA7436" } : { backgroundColor: "white" }}><i class="fa-solid fa-arrow-left"></i></button>
